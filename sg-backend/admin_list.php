...
<?php
    ...
    switch ($_GET['msg']){
    case 'create':
      $success_msg = "Admin create success";
      break;
    case 'edit':
      $success_msg = "Admin update success";
      break;
    case 'delete':
      $success_msg = "Admin delete success";    
      break;  
    ...
    switch ($_GET['err']){
      case 'create':
      $error_msg  = "Admin Create fail";
      break;
      case 'edit':
      $error_msg = "Admin Update fail";
      break;
      case  'shift':
