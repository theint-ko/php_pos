...
$process_error =false;
 ...
 if($cashier_name == ''){
    $process_error = true;
    $error = true;
    $error_message .= 'Please Fill Cashier name\n';
}
...
if($confirm_pass == ''){
 ...
 if ($confirm_pass == $password && $process_error == false) {
    ...
    $sql = "INSERT INTO user(username,password,role,created_at,created_by,updated_at,updated_by)
            VALUES ('$cashier_name','$md5_password','$cashier_role','$today_dt','$user_id','$today_dt','$user_id') ";


    $result = $mysqli->query($sql);
    $url=$cp_base_url."cashier_list.php?msg=edit";
                            ...
                            <div class="x_panel">
                                ...
                                <form class="" action="" method="post" novalidate enctype="multipart/form-data">
                                        ...
                                        <div class="field item form-group">
                                            <label for="name" class="col-form-label col-md-3 col-sm-3  label-align">Cashier Name<span class="required">*</span></label>
