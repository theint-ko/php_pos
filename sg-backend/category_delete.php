...
$delete_sql= "UPDATE `category` SET deleted_at = '$today_dt' ,deleted_by = '$user_id' WHERE id = '$id'";
...
<script>
    Swal.fire({
        ...
        if (result.isConfirmed) {
                    ...
                    if (data.status === 'success') {
                        Swal.fire({
                            ...
                            window.location.href =
                                '<?php echo $cp_base_url; ?>category_listing.php?msg=delete';
                        });
                    } else {
                        Swal.fire({
                            title: "Error!",
            ...
            window.location.href = '<?php echo $cp_base_url; ?>category_listing.php';
        }
    });
</script>
